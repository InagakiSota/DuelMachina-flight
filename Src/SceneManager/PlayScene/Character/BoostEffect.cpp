...
const std::vector<D3D11_INPUT_ELEMENT_DESC> BoostEffect::INPUT_LAYOUT =
{
...
//戻り値:なし
//////////////////////////
void BoostEffect::Create(DX::DeviceResources * deviceresources, ID3D11ShaderResourceView * texture, ID3D11InputLayout * inputLayout)
{
...
//戻り値:なし
//////////////////////////
void BoostEffect::Initialize(float life, DirectX::SimpleMath::Vector3 pos, DirectX::SimpleMath::Vector3 velocity)
{
	m_startPos = pos;
	m_startVel = velocity;
	m_startLife = life;
...
//戻り値:なし
//////////////////////////
void BoostEffect::Update(DX::StepTimer timer)
{
	...
	//距離でリセットする
	DirectX::SimpleMath::Vector3 len = m_pos - m_startPos;
	if (len.Length() > 3.0f) {
		Reset();
	}
...
void BoostEffect::Render()
{
	//ビルボード化
	m_world =
		//DirectX::SimpleMath::Matrix::CreateRotationY(10) * 
...
//戻り値:なし
//////////////////////////
void BoostEffect::SetRenderState(DirectX::SimpleMath::Vector3 camera, DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj)
{
	m_camera = camera;
	m_view = view;
	m_proj = proj;
...
//戻り値:
//////////////////////////
void BoostEffect::SetGravity(bool isGravity)
{
